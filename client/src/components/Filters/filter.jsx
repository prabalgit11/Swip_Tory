...
import unLikedSymbol from "./../../Assets/like.png";
import unBookmarkedSymbol from "./../../Assets/BookMark.png";
import closeSymbol from "./../../Assets/close(1).png";
import closeSymbol2 from "./../../Assets/close(2).jpg";
import shareSymbol from "./../../Assets/share.png";
import editSymbol from "./../../Assets/edit.png";
import leftSymbol from "./../../Assets/left.png";
import rightSymbol from "./../../Assets/right.png";
                                ...
                                <div className="story-card-slide">
                                    ...
                                    <div className="slide-progress-bar">
                                        {openedSlides.map((slide, index) => (
                                            <div
                                                key={index}
                                                className={`slide-progress-bar-item ${index === currentSlide ? "active" : ""
                                                    }`}
                                            ></div>
                                        ))}
                                    </div>
                                    ...
                                    {slides.map((_, index) => (
                                        <>
                                            <button
                                                ...
                                                className={`each-slide ${index === currentSlideIndex ? "selected-slide" : ""
                                                    }`}
                                            >
                                                Slide {index + 1}
                                            </button>
